Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
					...
					* Provide base table view and collection view classes with advanced features
                    ...
                    0.3.5
                    * TLIndexPathDataModel now emits a warning if a duplicate identifier is found. Duplicate identifiers will
                      lead to some APIs returning nil.
                    DESC
  s.homepage     = "http://tlindexpathtools.com"
  s.license      = { :type => "MIT" }
  s.author       = { "wtmoose" => "wtm@tractablelabs.com" }
  s.source       = { :git => "https://github.com/wtmoose/TLIndexPathTools.git", :tag => '0.3.5' }
  s.platform     = :ios, '6.0'
