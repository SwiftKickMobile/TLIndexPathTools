Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
					...
					* Provide base table view and collection view classes with advanced features
                    ...
                    0.3.3
                    * TLTableViewController now automatically calculates dynamic 
                      cell heights when using Auto Layout (see TLDynamicHeightView protocol).
                    DESC
  s.homepage     = "http://tlindexpathtools.com"
  s.license      = { :type => "MIT" }
  s.author       = { "wtmoose" => "wtm@tractablelabs.com" }
  s.source       = { :git => "https://github.com/wtmoose/TLIndexPathTools.git", :tag => '0.3.3' }
  s.platform     = :ios, '6.0'
